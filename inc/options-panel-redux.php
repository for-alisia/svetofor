<?php
    ...
    // Создаем переменную для настроек (с префиксом шаблона)
    $opt_name = "svetofor_options";
    ...
    $args['footer_text'] = __( '<p>Здесь отображаются настройки вашего сайта, чтобы вы легко могли изменять необходимые данные</p>', 'redux-framework-demo' );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'contacts',
        'desc'             => 'Основные данные компании: название, ссылки на соцсети, телефоны, логотип и тд.',
        'customizer_width' => '400px',
        'icon'             => 'el el-address-book'
    ) );
    //Данные о компании (используются в лого)
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'desc'     => 'Введите название компании (отображаетсяв логотипе)',
                'default'  => 'Светофор',
            ),
            array(
                'id'       => 'company_text',
                ...
                'desc'     => 'Введите слоган компании (отображается в логотипе второй строкой)',
                'default'  => 'Магазины низких цен',
            ),
            array(
                'id'       => 'company_logo',
                'type'     => 'media',
                'url'      => true,
                'title'    => 'Логотип',
                'desc'     => 'Выберите изображение логотипа, SVG файлы могут не отображаться на превью, но применятся на сайте',
                'default'  => array( 'url' => get_template_directory_uri().'/assets/img/logo.svg' ),
            ),
            array(
                'id'       => 'company_cart_icon',
                'type'     => 'media',
                'url'      => true,
                'title'    => 'Иконка корзины',
                'desc'     => 'Выберите изображение логотипа, SVG файлы могут не отображаться на превью, но применятся на сайте',
                'default'  => array( 'url' => get_template_directory_uri().'/assets/img/mdi_shopping_cart.svg' ),
            ),
        )
    ) );
    ...
    //Социальные сети 
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Социальные сети', 'svetofor' ),
        'id'               => 'social',
        'subsection'       => true,
        'customizer_width' => '600px',
        'fields'           => array(
            array(
                'id'       => 'social_links',
                'type'     => 'sortable',
                'title'    => 'Задайте ссылки на социальные сети компании',
                'description'=> 'Оставьте поле пустым, если у вас нет профиля в какой-либо сети, указывайте не более 4 ссылок, чтобы избежать визуальных проблем отображения',
                'label'    => true,
                'options'  => array(
                    'Vkontakte'          => '',
                    'Viber'              => '',
            ...
            array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => 'Картинка соцсети для основных страниц',
                'desc'     => 'Выберите изображение соцсети, SVG файлы могут не отображаться на превью, но применятся на сайте',
                'default'  => array( 'url' => get_template_directory_uri().'/assets/img/icons/vk.svg' ),
            ),
        )
    ) );
    //Способы связи (основной телефон, почта)
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Контактные данные', 'svetofor' ),
        'id'               => 'contact_us',
        'subsection'       => true,
        'customizer_width' => '600px',
        'fields'           => array(
            array(
                'id'       => 'phone-world',
                'type'     => 'text',
                'title'    => 'Контактный номер телефона в международном формате',
                'desc'     => 'Введите основной номер телефона, по которому можно с вами связаться (Используется для осуществления звонков)',
                'default'  => '+71234567890',
            ),
            array(
                'id'       => 'phone',
                'type'     => 'text',
                'title'    => 'Контактный номер телефона в удобном формате',
                'desc'     => 'Введите основной номер телефона, который будет отображаться на сайте (в удобном для пользователя виде)',
                'default'  => '+71234567890',
            ),
            array(
                'id'       => 'mail',
                ...
                'desc'     => 'Введите основной адрес электронной почты',
                'default'  => '',
            ),            
        ),        
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'vk-text',
                'type'     => 'text',
                'title'    => 'Текст для ссылки VK',
                'desc'     => 'Введите текст, который будет отображаться в футере и ведет на страницу группы VK',
                'default'  => 'Присоединяйтесь к нашей группе VK',
            ),
            array(
                'id'       => 'find-shop',
                'type'     => 'text',
                'title'    => 'Текст для ссылки выбора магазина',
                'desc'     => 'Введите текст ссылки, ведущей на страницу списка магазинов',
                'default'  => 'Найдите ближайший магазин',
            ),
            array(
                'id'       => 'mail_text',
                'type'     => 'text',
                'title'    => 'Текст для ссылки на почту',
                'validate' => 'text',
    ...
    //Данные страниц архива и единичных
    Redux::setSection( $opt_name, array(
        'title'            => 'Данные страниц',
        'id'               => 'pages-data',
        'desc'             =>  'Данные основных страниц',
        'customizer_width' => '400px',
        'icon'             => 'el el-website'
    ) );
    //Страница archive-shop
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'shops_archive_header',
                'type'     => 'text',
                'title'    => 'Заголовок страницы списка магазинов',
                'desc'     => 'Введите заголовок страницы, на которой отображается список всех имеющихся магазинов',
                'default'  => 'Магазины Пермского края',
            ),
            array(
                'id'       => 'shops_archive_select',
                'type'     => 'text',
                'title'    => 'Значение по умолчанию в списке выбора города',
                'desc'     => 'Введите значение, которое будет отображаться в списке выбора города',
                'default'  => 'Выберите город',
            ),
            array(
                'id'       => 'shops_archive_time_before',
                'type'     => 'text',
                'title'    => 'Текст в начале графика работы',
                'desc'     => 'Введите текст, который будет отображаться до времени открытия магазина (например, С или оставьте пустым)',
                'default'  => 'Каждый день с',
            ),
            array(
                'id'       => 'shops_archive_time_between',
                'type'     => 'text',
                'title'    => 'Текст в середине графика работы',
                'desc'     => 'Введите текст, который будет отображаться между временем открытия и закрытия (например, до или -)',
                'default'  => 'до',
            ),
            array(
                'id'       => 'shops_archive_time_after',
                'type'     => 'text',
                'title'    => 'Текст в конце графика работы',
                'desc'     => 'Введите текст, который будет отображатьсяпосле времени закрытия (например, без выходных или оставьте пустым)',
                'default'  => 'без выходных',
            ),
            array(
                'id'       => 'shops_archive_more_link',
                'type'     => 'text',
                'title'    => 'Текст ссылки на магазин',
                'desc'     => 'Введите текст ссылки, ведущей на страницу магазина',
                'default'  => 'Подробнее',
            ),
            array(
                'id'       => 'shops_archive_parking',
                'type'     => 'text',
                'title'    => 'Текст подсказки парковки',
                'desc'     => 'Введите текст всплывающей подсказки, появляющейся при наведении на иконку парковки',
                'default'  => 'Есть парковка',
            ),
            array(
                'id'       => 'shops_archive_alc',
                'type'     => 'text',
                'title'    => 'Текст подсказки алкоголь',
                'desc'     => 'Введите текст всплывающей подсказки, появляющейся при наведении на иконку бокала',
                'default'  => 'Продаем алкоголь',
            ),
            array(
                'id'       => 'shops_archive_credit',
                'type'     => 'text',
                'title'    => 'Текст подсказки карта',
                'desc'     => 'Введите текст всплывающей подсказки, появляющейся при наведении на иконку карты',
                'default'  => 'Принимаем карты',
            ),
            array(
                'id'       => 'shops_widget_header',
                'type'     => 'text',
                'title'    => 'Заголовок виджета магазинов',
                'desc'     => 'Введите текст заголовка виджета списка магазинов',
                'default'  => 'Наши магазины',
            ), 
            array(
                'id'       => 'shops_widget_link',
                'type'     => 'text',
                'title'    => 'Текст кнопки в виджете магазинов',
                'desc'     => 'Введите текст ссылки, ведущей на страницу списка магазинов',
                'default'  => 'Все магазины',
            ),

        )
    ) );
    //Страница single-shop
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'shop_single_vk_link',
                'type'     => 'text',
                'title'    => 'Текст ссылки на VK',
                'desc'     => 'Введите текст ссылки на группу магазина',
                'default'  => 'Свяжитесь с нами в VK',
            ),
           
            array(
                'id'       => 'shop_single_link_product',
                'type'     => 'text',
                'title'    => 'Текст ссылки на страницу товаров',
                'desc'     => 'Введите текст ссылки, которая ведет на страницу товаров',
                'default'  => 'Посмотреть предложения',
            ),
            array(
                'id'       => 'shop_single_link_shop',
                'type'     => 'text',
                'title'    => 'Текст ссылки на список магазинов',
                'desc'     => 'Введите текст ссылки, которая ведет на страницу со списком магазинов',
                'default'  => 'Выбрать другой магазин',
            ),
            

        )
    ) );
    //Страница archive-news
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'news_archive_header',
                'type'     => 'text',
                'title'    => 'Заголовок страницы списка новостей',
                'desc'     => 'Введите заголовок страницы списка новостей',
                'default'  => 'Наши новости',
            ),
            array(
                'id'       => 'news_archive_more',
                'type'     => 'text',
                'title'    => 'Название ссылки на новость',
                'desc'     => 'Введите название ссылки, которая будет вести на новость',
                'default'  => 'Подробнее',
            ),
            array(
                'id'       => 'news_posts_per_page',
                'type'     => 'text',
                'title'    => 'Количество постов на странице',
                'desc'     => 'Введите количество новостей, которые будут выводиться на странице',
                'default'  => '6',
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'link1-text',
                'type'     => 'text',
                'title'    => 'Надпись на кнопке выбора магазина',
                'desc'     => 'Введите текст, который будет отображаться на кнопке, ведущей на список магазинов',
                'default'  => 'Выбрать магазин',
            ),
            array(
                'id'       => 'link2-text',
                'type'     => 'text',
                'title'    => 'Надпись на кнопке возврата к списку новостей',
                'desc'     => 'Введите текст, который будет отображаться на кнопке, ведущей на список новостей',
                'default'  => 'Другие новости',
            ),           
        )
    ) );
    //Страница archive-product
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'product-header',
                'type'     => 'text',
                'title'    => 'Заголовок страницы списка товаров',
                'desc'     => 'Введите заголовок страницы списка товаров',
                'default'  => 'Лучшие предложения',
            ), 
            array(
                'id'       => 'product-posts-per-page',
                'type'     => 'text',
                'title'    => 'Количество товаров на странице',
                'desc'     => 'Введите количество товаров, отображаемых на странице. Рекомендуется 8, чтобы избежать проблем с отображением на больших разрешениях',
                'default'  => '8',
            ),  
            array(
                'id'       => 'product-price-old',
                'type'     => 'text',
                'title'    => 'Текст старой цены',
                'desc'     => 'Введите текст, который будет отображаться рядом с большей ценой',
                'default'  => 'Цена в других магазинах',
            ),
            array(
                'id'       => 'product-price-new',
                'type'     => 'text',
                'title'    => 'Текст новой цены',
                'desc'     => 'Введите текст, который будет отображаться рядом с меньшей ценой',
                'default'  => 'Наша цена',
            ),
            array(
                'id'       => 'product-button-text',
                'type'     => 'text',
                'title'    => 'Текст на кнопке магазинов',
                'desc'     => 'Введите текст, который будет отображаться на кнопке, ведущей на страницу магазинов',
                'default'  => 'Где купить',
            ),  
            array(
                'id'       => 'product-more-text',
                'type'     => 'text',
                'title'    => 'Текст на кнопке больше товаров',
                'desc'     => 'Введите текст, который будет отображаться на кнопке, ведущей на страницу товаров (используется на других страницах)',
                'default'  => 'Другие преложения',
            ),              
        )
    ) );
    //Страница О компании
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'about_company_header',
                'type'     => 'text',
                'title'    => 'Заголовок страницы О компании',
                'desc'     => 'Введите заголовок страницы',
                'default'  => 'О компании',
            ),     
        )
    ) );
     ...
     Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'shop_testadd',
                'type'     => 'textarea',
                'title'    => 'Объявление о доставке',
                'desc'     => 'Текст, объясняющий условия доставки ',
                'default'  => 'Доставка осуществляется по Перми и некоторым городам Пермского края.',
            ),
            array(
                'id'       => 'shop_cart_announcement',
                'type'     => 'textarea',
                'title'    => 'Объявление о доставке в корзине',
                'desc'     => 'Текст, объясняющий условия доставки ',
                'default'  => 'Сейчас доставка осуществляется по г.Пермь, г.Соликамск и г.Чусовой. Если вы не уверены, какой вариант доставки вам нужен, выберите любой, после оформления заказа с вами свяжется наш сотрудник и уточнит стоимость доставки.',
            ),
            array(
                'id'       => 'shop_cat_stock_info',
                'type'     => 'textarea',
                'title'    => 'Объявление о наличии товаров',
                'desc'     => 'Текст о возможности дозаказать товар ',
                'default'  => 'На сайте представлен не весь ассортимент товаров, вы можете получить консультацию и дозаказать товар по телефону',
            ),

            array(
                'id'       => 'shop_success_order',
                'type'     => 'textarea',
                'title'    => 'Объявление на странице успешного подтверждения заказа',
                'desc'     => 'Текст о звонке оператора ',
                'default'  => 'Наш сотрудник свяжется с вами для согласования точного времени доставки.',
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'partners_header',
                'type'     => 'text',
                'title'    => 'Заголовок страницы Партнерам',
                'desc'     => 'Введите заголовок страницы',
                'default'  => 'Партнерам',
            ), 
            array(
            ...
            array(
                'id'       => 'partners_rent',
                'type'     => 'text',
                'title'    => 'Заголовок второго таба',
                'desc'     => 'Введите заголовок второго таба',
                'default'  => 'Арендодателям',
            ),      
        )
    ) );
    //Главная страница
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'reason_header',
                'type'     => 'text',
                'title'    => 'Заголовок блока Причин',
                'desc'     => 'Введите заголовок',
                'default'  => 'Почему у нас такие низкие цены',
            ),     
        )
    ) );
    //Данные для банеров
    Redux::setSection( $opt_name, array(
        'title'            => 'Данные для банеров',
        'id'               => 'baner_data',
        'subsection'       => true,
        'customizer_width' => '600px',
        'fields'           => array(
            array(
                ...
                'desc'     => 'Введите текст, который будет идти после заголовка (ниаменование товара) и перед кеной',
                'default'  => 'всего за',
            ),
        )
    ) );
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'service_data',
        'desc'             => 'Служебные данные для корректной работы сайта',
        'customizer_width' => '400px',
        'icon'             => 'el el-wrench'
    ) );
     ...
     Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'map_api',
                'type'     => 'text',
                'title'    => 'API-ключ для яндекс карты',
                'desc'     => 'Введите API-ключ для использования Яндекс.Карт',
                'default'  => '',
            ),
            array(
                'id'       => 'map_version',
                'type'     => 'text',
                'title'    => 'Версия использования Яндекс.Карт',
                'desc'     => 'Введите номер версии Яндекс.Карт, которую хотите использовать (карты могут некорректно работать с мажорными версиями, выбирайте минорные)',
                'default'  => '2.1.73',
            ),
            array(
                'id'       => 'pin_img',
                'type'     => 'media',
                'url'      => true,
                'title'    => 'Вид маркера на карте',
                'desc'     => 'Выберите изображение маркера, отображаемого на карте, SVG файлы могут не отображаться на превью, но применятся на сайте',
                'default'  => array( 'url' => get_template_directory_uri().'/assets/img/icons/map-marker.svg' ),
            ),
            array(
                'id'       => 'pin_img_enter',
                'type'     => 'media',
                'url'      => true,
                'title'    => 'Вид маркера на карте при наведении мыши',
                'desc'     => 'Выберите изображение маркера, отображаемого на карте при наведении мыши, SVG файлы могут не отображаться на превью, но применятся на сайте',
                'default'  => array( 'url' => get_template_directory_uri().'/assets/img/icons/map-marker-red.svg' ),
            ),
            array(
                'id'       => 'map_center_lang',
                'type'     => 'text',
                'title'    => 'Первая координата центра карты',
                'desc'     => 'Введите первую координату точки, где будет расположен центр карты с магазинами',
                'default'  => '57.83786557658559',
            ),
            array(
                'id'       => 'map_center_alt',
                'type'     => 'text',
                'title'    => 'Вторая координата центра карты',
                'desc'     => 'Введите вторую координату точки, где будет расположен центр карты с магазинами',
                'default'  => '56.2782564318729',
            ),
            array(
                'id'       => 'map_zoom',
                'type'     => 'text',
                'title'    => 'Масштаб карты',
                'desc'     => 'Введите коэффициент зума для карты',
                'default'  => '7',
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'use_slick_slider',
                'type'     => 'checkbox',
                'title'    => 'Использовать слайдер магазинов',
                'desc'     => 'Если не заданы изображения магазинов, лучше отключить использование слайдера',
                'default'  => '1',
            ),         
     ...
     //Ключи, верификации, SEO
     Redux::setSection( $opt_name, array(
        'title'            => 'Настройки ключей и верификаций',
        'id'               => 'key_seo',
        'subsection'       => true,
        'customizer_width' => '600px',
        'fields'           => array(
            array(
                'id'       => 'yandex_ver',
                'type'     => 'textarea',
                'title'    => 'Код верификации от Яндекса',
                'desc'     => 'Введите код, необходимый, чтобы подтвердить права на домен (взять его можно в кабинете разработчика Яндекса)',
                'default'  => '',
            ),
            array(
                'id'       => 'vk_ver',
                'type'     => 'textarea',
                'title'    => 'Код добавления виджета ВК',
                'desc'     => 'Введите код, добавляющий ВК виджет на ваш сайт',
                'default'  => '',
            ),
